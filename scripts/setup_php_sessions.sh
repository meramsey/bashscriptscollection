...
mkdir -p /var/lib/lsphp/session/lsphp{53,54,55,56,70,71,72,73,74,80,81}
chmod -R 1733 /var/lib/lsphp/session/lsphp{53,54,55,56,70,71,72,73,74,80,81}
...
command="/usr/local/CyberCP/bin/python /usr/local/CyberCP/IncBackups/IncScheduler.py Weekly"
job="0 0 * * 0 $command"
